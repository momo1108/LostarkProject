  ...
  return (
    <div className={styles.resultContainer}>
      ...
      <div className={styles.resultDiv2}>
        ...
        <div data-role="header" className={styles.priceListDiv}>
          매물 가격
        </div>
        ...
        {responseData.length ? (
          responseData.map((skill: TripodResType, skillIndex) => (
            <Fragment key={`result_skill_${skill.Name}`}>
                    ...
                    >
                      ...
                      >
                        <Empty
                          ...
                          width={2}
                        />
                        <p className={tripodTierToStyleMap.color[tripodIndex]}>
                          티어{tripodIndex + 1}
                        </p>
                      </div>
                    </div>
                  ...
                  tripod ? (
                    ...
                    >
                      ...
                      <li
                        ...
                        onMouseEnter={() => {
                          setCurrentSkillTripodIndex([skillIndex, tripodIndex]);
                        }}
                      >
                        <List size={20} />
                        <span>확인</span>
              ...
              {skillIndex % 2 ? <></> : <div className={styles.gapItem}></div>}
            </Fragment>
          ))
        ) : (
