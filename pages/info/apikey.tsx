    ...
    <Page className={`${styles.container} ${nanumNeo.className}`}>
      ...
      <div className={styles.infoBody}>
        ...
        <div className={styles.infoContent}>
          <p className={styles.p1}>1. 로스트아크 공식 OpenAPI 홈페이지 접속</p>
          ...
          <img className={styles.infoImage} src="/images/info_1_1.png" alt="" />
          <p className={styles.p2}>
          ...
          <p className={styles.p2}>
            2-2. 로그인이 완료됐으면 중앙의{" "}
            <span className={styles.infoButton}>GET ACCESS TO LOSTARK API</span>{" "}
            버튼을 클릭하여 발급 신청 페이지로 이동합니다.
          </p>
          <div className={styles.sep} />
          <p className={styles.p1}>
            3. 페이지 이동 후 중앙의{" "}
            <span className={styles.infoButton2}>CREATE NEW CLIENT</span> 버튼을
            클릭하여 정보 입력 페이지로 이동
          </p>
          <img className={styles.infoImage} src="/images/info_1_2.png" alt="" />
          <div className={styles.sep} />
          <p className={styles.p1}>4. 정보 입력 페이지 작성</p>
          <img className={styles.infoImage} src="/images/info_1_3.png" alt="" />
          <p className={styles.p2}>
            4-1. 입력란 중 <span style={{ color: "#f00" }}>*</span> 표시가
            되어있는 <span className={styles.infoInputTitle}>CLIENT NAME</span>{" "}
            항목만 작성합니다.
            <br />
          ...
          <p className={styles.p2}>
            ...
            <span className={styles.infoButton3}>CREATE</span> 버튼을 클릭한 후
            팝업창을 닫아서 생성을 완료합니다.
          </p>
          <div className={styles.sep} />
          <p className={styles.p1}>5. 발급받은 API Key 등록</p>
          <img className={styles.infoImage} src="/images/info_1_4.png" alt="" />
          <p className={styles.p2}>
            5-1. 생성 된 API Key 값을{" "}
            <span className={styles.infoButton4}>COPY</span> 버튼을 눌러서
            복사합니다. <br />
            만약 위 페이지가 보이지 않으면, 아래 링크를 통해 접속하세요. <br />
            <Link
          ...
          <div className={styles.sep2} />
          <img className={styles.infoImage} src="/images/info_1_6.png" alt="" />
          <p className={styles.p2}>
