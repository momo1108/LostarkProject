  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:site_name" content="로아플(Loaple)" />
        <meta
          property="og:title"
          content="로아플(Loaple) - 로스트아크 도우미(Lostark Helper)"
        />
        <meta
          property="og:description"
          content="로스트아크 도구모음. 로아플은 세계에서 가장 작은 로스트아크 웹서비스로, 혼자 야무지게 만든 웹서비스입니다."
        />
        <meta property="og:image" content="/images/loaple_seo.jpg" />
        <meta property="og:url" content="http://loaple.site" />

        <meta property="twitter:card" content="summary" />
        <meta property="twitter:site" content="로아플(Loaple)" />
        <meta
