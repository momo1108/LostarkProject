...
// type EngravePageSelectorContextType = {
//   pageStatus: number;
...
// };
// const EngravePageSelectorContext = createContext<
//   EngravePageSelectorContextType | undefined
// >(undefined);
// const useEngravePageSelectorContext = () => {
//   const context = useContext(EngravePageSelectorContext);
//   if (!context)
//     throw new Error(
//       "useEngravePageSelectorContext must be used within a EngravePageSelectorContext"
//     );
//   return context;
// };

// type EngravePageActionContextType = {
...
//   setApiShine: Dispatch<SetStateAction<boolean>>;
...
// };
// const EngravePageActionContext = createContext<
//   EngravePageActionContextType | undefined
// >(undefined);
// const useEngravePageActionContext = () => {
//   const context = useContext(EngravePageActionContext);
//   if (!context)
//     throw new Error(
//       "useEngravePageActionContext must be used within a EngravePageActionContext"
//     );
//   return context;
// };

// const EngravePageProvider = ({ children }: { children: React.ReactNode }) => {
...
//   return (
//     <EngravePageSelectorContext.Provider value={selectorContextValue}>
//       <EngravePageActionContext.Provider value={actionContextValue}>
//         {children}
//       </EngravePageActionContext.Provider>
//     </EngravePageSelectorContext.Provider>
//   );
// };
